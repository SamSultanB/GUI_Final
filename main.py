...
class GUI:
    ...
    def main(self):
        ...
        self.waterMark = Label(self.tk, text='WaterMark: ', bg='PINK', font=("ariel 17 bold"))
        self.waterMark.place(x=245, y=65)
        self.entry_text = Entry(self.tk, width=25)
        self.entry_text.place(x=385, y=73)
        self.button1 = Button(text='Print', font=('underline'), relief=RAISED, command=self.__waterMark)
        self.button1.place(x=540, y=65)

        self.resize = Label(self.tk, text='Size:', bg='PINK', font=("ariel 17 bold"))
        ...
        self.filter = Label(self.tk, text="Filter:", bg='PINK', font=("ariel 17 bold"))
